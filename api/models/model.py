...
class App(db.Model):
    ...
    app_model_config_id = db.Column(UUID(as_uuid=True), nullable=True)
...
class InstalledApp(db.Model):
    ...
    tenant_id = db.Column(UUID(as_uuid=True), nullable=False)
    app_id = db.Column(UUID(as_uuid=True), nullable=False)
    app_owner_tenant_id = db.Column(UUID(as_uuid=True), nullable=False)
    position = db.Column(db.Integer, nullable=False, default=0)
...
class Conversation(db.Model):
    ...
    id = db.Column(UUID(as_uuid=True), server_default=db.text('uuid_generate_v4()'))
    app_id = db.Column(UUID(as_uuid=True), nullable=False)
    app_model_config_id = db.Column(UUID(as_uuid=True), nullable=False)
...
class MessageFeedback(db.Model):
    ...
    message_id = db.Column(UUID(as_uuid=True), nullable=False)
...
class MessageFile(db.Model):
    ...
    upload_file_id = db.Column(UUID(as_uuid=True), nullable=True)
...
class EndUser(UserMixin, db.Model):
    ...
    id = db.Column(UUID(as_uuid=True), server_default=db.text('uuid_generate_v4()'))
    tenant_id = db.Column(UUID(as_uuid=True), nullable=False)
    app_id = db.Column(UUID(as_uuid=True), nullable=True)
    type = db.Column(db.String(255), nullable=False)
...
class UploadFile(db.Model):
    ...
    used_by = db.Column(UUID(as_uuid=True), nullable=True)
...
class ApiRequest(db.Model):
    ...
    id = db.Column(UUID(as_uuid=True), nullable=False, server_default=db.text('uuid_generate_v4()'))
    tenant_id = db.Column(UUID(as_uuid=True), nullable=False)
    api_token_id = db.Column(UUID(as_uuid=True), nullable=False)
...
class MessageAgentThought(db.Model):
    ...
    id = db.Column(UUID(as_uuid=True), nullable=False, server_default=db.text('uuid_generate_v4()'))
    message_id = db.Column(UUID(as_uuid=True), nullable=False)
    message_chain_id = db.Column(UUID(as_uuid=True), nullable=False)
    ...
    # plugin_id = db.Column(UUID(as_uuid=True), nullable=True)  ## for future design
...
class DatasetRetrieverResource(db.Model):
    ...
    message_id = db.Column(UUID(as_uuid=True), nullable=False)
    position = db.Column(db.Integer, nullable=False)
    dataset_id = db.Column(UUID(as_uuid=True), nullable=False)
    ...
    segment_id = db.Column(UUID(as_uuid=True), nullable=False)
